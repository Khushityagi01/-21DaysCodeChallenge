...
class BST:
    ...
    def deleteData(self,data):
        return False # In this case we can return true of false.Representing whether the data is present or not.
    
    
    def count(self):
        return 0  #it simply return the number of nodes in my tree.
